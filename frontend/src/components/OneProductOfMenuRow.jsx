...
const OneProductOfMenuRow = ({ productOfMenu }) => {
  return (
    <div>
        ...
        <div className="background-menu flex flex-col text-center text-white pt-6">
          <div className="rounded-lg mx-auto p-6">
            ...
            <div>
              ...
              <p className="text-3xl font-titre mb-4">{productOfMenu.start_title}</p>
            </div>
            <div>
              <h2 className="text-xl font-titre -mb-3 text-orange">Plat</h2>
              <p className="text-3xl font-titre mb-4">{productOfMenu.main_course}</p>
            </div>
            <div>
              <h2 className="text-xl font-titre -mb-3 text-orange">Dessert</h2>
              <p className="text-3xl font-titre mb-4">{productOfMenu.dessert}</p>
            </div>
          </div>
        </div>
      </div>
